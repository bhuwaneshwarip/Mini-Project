...
public class MiniProject {
	...
	public static void main(String[] args)
		...
		// throws SQLException, ClassNotFoundException {
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost/miniproject", "root", "root");
		 ...
		 static boolean login()
		{
			...
			try {
				Class.forName("com.mysql.cj.jdbc.Driver");
				Connection con=DriverManager.getConnection("jbdc:mysql://localhost:3306/SMS","root","root");
